...
I'm a **Full Stack Software Developer** with solid experience building and maintaining **production-ready web systems**, working mainly with **PHP (Laravel, WordPress), Node.js, and React**.
...
Alongside my professional experience, I maintain an **active interest in software architecture, systems fundamentals, and low-level software engineering concepts**, continuously deepening my understanding to evolve as a software engineer.
...
- 🌍 Experience working on projects for different markets  
...
- Building robust and scalable web systems  
- Improving performance and system reliability  
- Deepening knowledge in **software architecture and system fundamentals**  
